...
@Operation(operationId = "findBoardListById", summary = "Get a specific board list by ID")
@SecurityRequirement(name = "bearerAuth")
@ApiResponses(value = {
  @ApiResponse(
    responseCode = "200",
    description = "Board list found and returned.",
...
public @interface FindBoardListByIdDocs {
}
