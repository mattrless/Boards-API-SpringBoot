...
create table board_lists (
    position numeric(38,2) not null,
...
create table card_assignments (
    ...
    user_id bigint not null,
    primary key (id),
    constraint uk_card_assignment_card_user unique (card_id, user_id)
);
...
alter table if exists board_lists 
...
alter table if exists card_assignments 
    add constraint FK5qoi06yk75qaxtngd5t0usajf 
    foreign key (card_id) 
    references cards;

alter table if exists card_assignments 
    add constraint FK5asncdgo47wpovhqka6s43s88 
    foreign key (user_id) 
    references users;

alter table if exists cards 
    add constraint FK6ej8m0ufhvwgyos8ky9rbsuf 
    foreign key (board_list_id) 
    references board_lists;
